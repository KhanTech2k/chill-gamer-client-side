        ...
        <footer className="py-16 mt-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div>
                        <h2 className="text-xl font-bold mb-4">Chill Gamer</h2>
                        <p className="text-gray-400 text-sm">
                            Dive into the world of gaming with unbiased reviews, the latest news, and updates on trending games.
                        </p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 text-sm mb-4">
                            Subscribe to stay updated on the latest reviews and gaming news.
                        </p>
